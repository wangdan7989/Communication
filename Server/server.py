        ...
        while(self.r):
            try:
                ...
                if len(infds) > 0:
                    ...
                    sock.sendto("MulticastServer" + str(i), client)#client
                    i += 1
            except:
                break
...
def main(argv):
    try:
        ...
        mserver.start()
        mclient1 = MulticastClient(("0.0.0.0", 10011), ("224.0.1.255", 10010))
        mclient1.start()

        mclient2 = MulticastClient(("0.0.0.0", 10012), ("224.0.1.255", 10010))
        mclient2.start()
        mclient3 = MulticastClient(("0.0.0.0", 10013), ("224.0.1.255", 10010))
        mclient3.start()
        mclient4 = MulticastClient(("0.0.0.0", 10014), ("224.0.1.255", 10010))
        mclient4.start()
